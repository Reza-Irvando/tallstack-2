    ...
    <div class="space-y-2">
        @if ($notes->isEmpty())
            <div class="text-center">
                ...
                <x-button primary icon-right="plus" class="mt-6" href="{{ route('notes.create') }}" wire:navigate>Tambah Note </x-button>
            </div>
        @else
            <x-button class="mb-12" primary icon-right="plus" href="{{ route('notes.create') }}" wire:navigate>Tambah Note</x-button>
                    ...
                    <x-card wire:key='{{ $note->id }}'>
                        <div class="flex justify-between">
                            <div>
                                ...
                                @endcan
                                <p class="mt-2 text-l">{{ Str::limit($note->body, 50) }}</p>
                            </div>
                        </div>
                        <div class="flex items-end justify-between mt-4 space-x-1">
                            ...
                            <div>
                                <x-button.circle icon="information-circle"
